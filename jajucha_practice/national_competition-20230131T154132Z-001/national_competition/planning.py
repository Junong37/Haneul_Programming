...
global canny_threshold_l
canny_threshold_l = 130

global canny_threshold_h
canny_threshold_h = 140
...
class LaneDetector:
    ...
    def canny(self, img, par1= canny_threshold_l, par2=canny_threshold_h):       #200, 400
    ...
    def findLines(self, img):
        ...
        edge = self.canny(img, canny_threshold_l, canny_threshold_h)  #200, 600
...
class BasePlanning:
    ...
    def gridFront(self, img, cols=9, rows=5, update_img=False):
        img2 = self._front_img
